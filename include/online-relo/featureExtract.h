...
public:
    ...
    pcl::PointCloud<VelodynePointXYZIRT>::Ptr laserCloudIn;
    ...
    fast_lio_sam::cloud_info cloudInfo;
    double timeScanCur;
    double timeScanEnd;
    cv::Mat rangeMat;
    ...
    FeatureExtract()
    {
        ...
        pubLaserCloudInfo = nh.advertise<fast_lio_sam::cloud_info>("/feature/cloud_info", 1);
    ...
    void allocateMemory()
    {
        laserCloudIn.reset(new pcl::PointCloud<VelodynePointXYZIRT>());
